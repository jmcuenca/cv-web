...
type ThemeConfig = {
  ...
  templateName: string
  keywords :string
  templateTitleDescription: string
...
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: 'ContractVault' /* App Name */,
  templateTitleDescription: 'Registro de contratos inteligentes' /* App Name */,
  templateDescription: 'Aplicación para el registro de contratos entre personas que tengan un proyecto en común' /* App Name */,
